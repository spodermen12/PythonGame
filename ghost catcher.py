...
for index in range(20):
    ghost1wave.append(Image("ghost1.png",game))
    
for index in range(20):
    x = randint(100,800)
    y = randint(100,500)
    ghost1wave[index].moveTo(-x, y)
    ghost1wave[index].resizeBy(-40)
    ghost1wave[index].setSpeed(6,90)
'''
...
while not game.over:
    ...
    #game.drawText("Souls Collected = " + str(SoulsCollected),20, 40)
